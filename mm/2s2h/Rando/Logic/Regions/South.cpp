...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_DEKU_PALACE_INSIDE_UPPER_BEAN_SIDE] = RandoRegion { .name = "Inside, Upper", .sceneId = SCENE_22DEKUCITY,
        .checks = {
            CHECK(RC_ENEMY_DROP_MAD_SCRUB, CanKillEnemy(ACTOR_EN_DEKUNUTS) && CAN_BE_DEKU),
            CHECK(RC_DEKU_PALACE_BEAN_SIDE_MOVING_PLATFORM_DEKU_FLOWER_2, CanKillEnemy(ACTOR_EN_DEKUNUTS) && CAN_BE_DEKU),
        },
        .connections = {
    ...
    Regions[RR_ROAD_TO_SOUTHERN_SWAMP] = RandoRegion{ .sceneId = SCENE_24KEMONOMITI,
        .checks = {
            ...
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_TREE_01, true),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_TREE_02, true),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_TREE_03, true),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_TREE_04, true),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_TREE_05, true),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_TREE_06, true),
            ...
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_DEKU_FLOWER_PATH_TO_TERMINA_1, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_DEKU_FLOWER_PATH_TO_TERMINA_2, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_DEKU_FLOWER_PATH_TO_TERMINA_3, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_DEKU_FLOWER_PATH_TO_ARCHERY_HOUSE_1, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_DEKU_FLOWER_PATH_TO_ARCHERY_HOUSE_2, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_DEKU_FLOWER_PATH_TO_ARCHERY_HOUSE_3, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_DEKU_FLOWER_PATH_TO_SWAMP_1, CAN_BE_DEKU),
            CHECK(RC_ROAD_TO_SOUTHERN_SWAMP_DEKU_FLOWER_PATH_TO_SWAMP_2, CAN_BE_DEKU),
        },
        .exits = { //     TO                                         FROM
