...
static RegisterShipInitFunc initFunc([]() {
    Regions[RR_MOON_DEKU_TRIAL] = RandoRegion{ .sceneId = SCENE_LAST_DEKU,
        .checks = {
            ...
            CHECK(RC_MOON_TRAIL_DEKU_ROTATING_PLATFORM_SET_1_DEKU_FLOWER_1, CAN_BE_DEKU),
            CHECK(RC_MOON_TRAIL_DEKU_ROTATING_PLATFORM_SET_1_DEKU_FLOWER_2, CAN_BE_DEKU),
            CHECK(RC_MOON_TRAIL_DEKU_ROTATING_PLATFORM_SET_2_GOLD_DEKU_FLOWER, CAN_BE_DEKU),
            CHECK(RC_MOON_TRAIL_DEKU_ROTATING_PLATFORM_SET_2_PINK_DEKU_FLOWER, CAN_BE_DEKU),
        },
        .exits = { //     TO                                         FROM
